...
/* USER CODE BEGIN PV */
osMessageQueueId_t RightKeyQueueHandle;
osMessageQueueId_t LeftKeyQueueHandle;
osMessageQueueId_t UpKeyQueueHandle;
osMessageQueueId_t DownKeyQueueHandle;
const osMessageQueueAttr_t RightKeyQueueHandle_attributes = {
    .name = "RightKeyQueue"
};
const osMessageQueueAttr_t LeftKeyQueueHandle_attributes = {
    .name = "LeftKeyQueue"
};
const osMessageQueueAttr_t UpKeyQueueHandle_attributes = {
    .name = "UpKeyQueue"
};
const osMessageQueueAttr_t DownKeyQueueHandle_attributes = {
    .name = "DownKeyQueue"
};
/* USER CODE END PV */
